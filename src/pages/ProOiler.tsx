...
import { ArrowLeft, CheckCircle2, Zap, Settings, ArrowRight, Activity, Layers, ShieldCheck, Crosshair, Droplets, Filter, Thermometer } from 'lucide-react';
import { Link } from 'react-router-dom';

export default function ProOiler() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-20 w-full pt-32 pb-20 flex flex-col lg:flex-row items-center gap-12">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-display font-bold text-white uppercase tracking-widest leading-[0.9] mb-8 drop-shadow-2xl">
              Pro<span className="text-[#540214]">Oiler</span>
            </h1>
            ...
            <p className="text-xl md:text-2xl text-[#8C9291] font-light mb-12 max-w-2xl leading-relaxed">
              Advanced Lube Farm System for optimal machinery performance. Completely pre-wired and skid-mounted for easy installation.
            </p>
          ...
          >
            <img 
              src="/Products/ProOiler/ProOiler.png" 
              alt="ProOiler" 
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 divide-y md:divide-y-0 md:divide-x divide-black/10">
            ...
            >
              ...
              <div className="text-sm font-bold uppercase tracking-[0.2em] text-[#450f1a]">150-Gallon Tanks</div>
              <p className="text-[#333333] text-sm mt-3 font-light">With thermostatic controlled heaters</p>
            </motion.div>
            ...
            >
              ...
              <div className="text-sm font-bold uppercase tracking-[0.2em] text-[#450f1a]">Oil Filtration</div>
              <p className="text-[#333333] text-sm mt-3 font-light">With dirty filter pressure sensing</p>
            </motion.div>
            ...
            >
              ...
              <div className="text-sm font-bold uppercase tracking-[0.2em] text-[#450f1a]">Grease Filtration</div>
              <p className="text-[#333333] text-sm mt-3 font-light">Pressurized lube circuit with 15:1 pneumatic pump</p>
            </motion.div>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-20">
            ...
            <p className="text-[#8C9291] mt-6 max-w-2xl mx-auto font-light text-lg">
              Engineered for precision, security, and seamless integration. Discover the core features that drive the ProOiler system.
            </p>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            
            {/* Card 1: Robust Storage */}
            <motion.div 
            ...
            >
              ...
              <h3 className="text-2xl font-display font-bold text-[#222222] mb-4 uppercase tracking-wide relative z-10 transition-colors duration-300">
                Robust <span className="text-[#450f1a]">Storage</span>
              </h3>
              
              <p className="text-[#333333] font-light leading-relaxed mb-8 relative z-10 flex-grow transition-colors duration-300">
                Three 150-gallon oil tanks equipped with visual site glass, thermostatic controlled heaters, and comprehensive sensors.
              </p>
              
              <ul className="space-y-4 relative z-10 mt-auto">
                <li className="flex items-start gap-3 group/item">
                  <Thermometer className="w-5 h-5 text-[#450f1a] flex-shrink-0 mt-0.5 transition-colors duration-300" />
                  <span className="text-[#333333] font-light text-sm transition-colors duration-300">Thermostatic controlled 480VAC tank heaters</span>
                </li>
                <li className="flex items-start gap-3 group/item">
                  <Activity className="w-5 h-5 text-[#450f1a] flex-shrink-0 mt-0.5 transition-colors duration-300" />
                  <span className="text-[#333333] font-light text-sm transition-colors duration-300">Oil level and temperature sensor</span>
                </li>
              </ul>
            </motion.div>

            {/* Card 2: Advanced Filtration */}
            <motion.div 
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            ...
            >
              ...
              <h3 className="text-2xl font-display font-bold text-[#222222] mb-4 uppercase tracking-wide relative z-10 transition-colors duration-300">
                Advanced <span className="text-[#450f1a]">Filtration</span>
              </h3>
              
              <p className="text-[#333333] font-light leading-relaxed mb-8 relative z-10 flex-grow transition-colors duration-300">
                Comprehensive filtration for both oil and grease circuits, including dirty filter pressure sensing to ensure optimal performance.
              </p>
              
              <ul className="space-y-4 relative z-10 mt-auto">
                <li className="flex items-start gap-3 group/item">
                  <ShieldCheck className="w-5 h-5 text-[#450f1a] flex-shrink-0 mt-0.5 transition-colors duration-300" />
                  <span className="text-[#333333] font-light text-sm transition-colors duration-300">10&mu;m oil filter and 100&mu;m grease filter</span>
                </li>
                <li className="flex items-start gap-3 group/item">
                  <Layers className="w-5 h-5 text-[#450f1a] flex-shrink-0 mt-0.5 transition-colors duration-300" />
                  <span className="text-[#333333] font-light text-sm transition-colors duration-300">Inlet oil filtration and breather filters</span>
                </li>
              </ul>
            </motion.div>

            {/* Card 3: Easy Installation */}
            <motion.div 
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            ...
            >
              ...
              <h3 className="text-2xl font-display font-bold text-[#222222] mb-4 uppercase tracking-wide relative z-10 transition-colors duration-300">
                Easy <span className="text-[#450f1a]">Installation</span>
              </h3>
              
              <p className="text-[#333333] font-light leading-relaxed mb-8 relative z-10 flex-grow transition-colors duration-300">
                Self-supporting steel skid mounted design with an oil containment pan. Completely pre-wired to on-board control enclosure.
              </p>
              
              <ul className="space-y-4 relative z-10 mt-auto">
                <li className="flex items-start gap-3 group/item">
                  <Zap className="w-5 h-5 text-[#450f1a] flex-shrink-0 mt-0.5 transition-colors duration-300" />
                  <span className="text-[#333333] font-light text-sm transition-colors duration-300">Pressurized lube circuits with pneumatic pumps</span>
                </li>
                <li className="flex items-start gap-3 group/item">
                  <CheckCircle2 className="w-5 h-5 text-[#450f1a] flex-shrink-0 mt-0.5 transition-colors duration-300" />
                  <span className="text-[#333333] font-light text-sm transition-colors duration-300">Saw Lube / Spindle Lub / Slideway Oil</span>
                </li>
              </ul>
            </motion.div>
      ...
      <section className="py-16 px-6 md:px-16 relative overflow-hidden bg-[#0a0a0a]">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p className="text-lg text-[#EBEDEF] font-light mb-10 max-w-2xl mx-auto">
            Contact our engineering team today to discuss how the ProOiler system can integrate into your existing line and maximize your recovery.
          </p>
          <Link 
            to="/contact" 
