...
import { ArrowLeft, CheckCircle2, Zap, Settings, ArrowRight, Activity, Layers, ShieldCheck, Crosshair, Cpu } from 'lucide-react';
import { Link } from 'react-router-dom';

export default function CantOutfeedSweep() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-20 w-full pt-32 pb-20 flex flex-col lg:flex-row items-center gap-12">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-display font-bold text-white uppercase tracking-widest leading-[0.9] mb-8 drop-shadow-2xl">
              Cant Outfeed <span className="text-[#540214]">Sweep</span>
            </h1>
            <h2 className="text-2xl md:text-4xl font-display text-[#EBEDEF] mb-8 leading-tight">
              Seamless Linear-to-Transverse Transfer.
            </h2>
            <p className="text-xl md:text-2xl text-[#8C9291] font-light mb-12 max-w-2xl leading-relaxed">
              Automatically control the linear-to-transverse transfer of cants from the primary breakdown to the gang saw with servo-driven precision and live fence technology.
            </p>
          ...
          >
            <img 
              src="/Products/Cant-outfeed-sweep/Cant-outfeed-sweep.png" 
              alt="Cant Outfeed Sweep" 
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 divide-y md:divide-y-0 md:divide-x divide-black/10">
            ...
            >
              ...
              <p className="text-[#333333] text-sm mt-3 font-light">Fast and accurate sweeping of cants via lug chains</p>
            </motion.div>
            ...
            >
              ...
              <div className="text-sm font-bold uppercase tracking-[0.2em] text-[#450f1a]">Fence</div>
              <p className="text-[#333333] text-sm mt-3 font-light">Prevents skewing caused by cant hanging on fence</p>
            </motion.div>
            ...
            >
              ...
              <div className="text-sm font-bold uppercase tracking-[0.2em] text-[#450f1a]">Startup</div>
              <p className="text-[#333333] text-sm mt-3 font-light">Pre-wired and tested for seamless installation</p>
            </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            >
              <h3 className="text-2xl font-display font-bold text-[#222222] mb-6 uppercase tracking-wide">
                Servo Controlled <span className="text-[#222222]">Sweeping</span>
              </h3>
              <div className="w-20 h-1.5 bg-[#450f1a] mb-8"></div>
              <p className="text-[#333333] text-lg mb-8 font-light leading-relaxed">
                Automatically control the linear-to-transverse transfer of cants from the primary breakdown to the gang saw. Servo motor controlled lug chains provide fast and accurate sweeping of cants from the linear flow to the ending rolls.
              </p>
              <ul className="space-y-6">
                {[
                  { text: "Fast & Accurate servo motor controlled lug chains", icon: Zap },
                  { text: "Automated transfer from primary breakdown to gang saw", icon: Cpu },
                  { text: "Precise sweeping from linear flow to ending rolls", icon: ArrowRight }
                ].map((item, idx) => (
            ...
            {/* Independent Ending Rolls & Live Fence */}
            <motion.div 
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            ...
            >
              ...
              <div className="relative z-10">
                <h3 className="text-2xl font-display font-bold text-[#222222] mb-6 uppercase tracking-wide">
                  Ending Rolls & <span className="text-[#450f1a]">Live Fence</span>
                </h3>
                <div className="w-20 h-1.5 bg-[#450f1a] mb-8"></div>
                <p className="text-[#333333] text-lg mb-8 font-light leading-relaxed">
                  Even-end cants to a near or far end lumberline with a second, independently controlled set of ending rolls. The live fence prevents skewing caused by the end of the cant hanging on the fence after even-ending.
                </p>
                <ul className="space-y-6">
                  {[
                    { text: "Independent control for near or far lumberlines", icon: Layers },
                    { text: "Live fence technology prevents cant skewing", icon: ShieldCheck },
                    { text: "Ensures precise positioning for downstream processing", icon: Crosshair },
                    { text: "Pre-wired and tested for seamless installation", icon: Settings }
                  ].map((item, idx) => (
                    <li key={idx} className="flex items-start gap-4 group">
                      <div className="w-12 h-12 rounded-xl bg-[#450f1a] flex items-center justify-center flex-shrink-0">
                        <item.icon className="w-6 h-6 text-white" />
      ...
      <section className="py-16 px-6 md:px-16 relative overflow-hidden bg-[#0a0a0a]">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <h2 className="text-4xl md:text-5xl font-display font-bold text-white uppercase tracking-widest mb-6 drop-shadow-lg">
            Ready to Upgrade Your <span className="font-bold text-[#540214]">Transfer?</span>
          </h2>
          <p className="text-lg text-[#EBEDEF] font-light mb-10 max-w-2xl mx-auto">
            Contact our team today to discuss how the Cant Outfeed Sweep can transform your intermediate processing.
          </p>
          <Link 
            to="/contact" 
