...
export default function DynamicLinebar() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-20 w-full pt-32 pb-20 flex flex-col lg:flex-row items-center gap-12">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-display font-bold text-white uppercase tracking-widest leading-[0.9] mb-8 drop-shadow-2xl">
              Dynamic <span className="text-[#540214]">Linebar</span>
            </h1>
            <h2 className="text-2xl md:text-4xl font-display text-[#EBEDEF] mb-8 leading-tight">
              Precision Positioning for Maximum Productivity.
            </h2>
            <p className="text-xl md:text-2xl text-[#8C9291] font-light mb-12 max-w-2xl leading-relaxed">
              Independently actuated tipple chains transport the cant to a dynamically positioned linebar, centering the cant on the scan belt to reduce cutting tool set times and improve overall gang productivity.
            </p>
          ...
          >
            <img 
              src="/Products/Dynamic-linebar/Dynamic-linebar.png" 
              alt="Dynamic Linebar" 
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 divide-y md:divide-y-0 md:divide-x divide-black/10">
            ...
            >
              ...
              <div className="text-sm font-bold uppercase tracking-[0.2em] text-[#450f1a]">Driven</div>
              <p className="text-[#333333] text-sm mt-3 font-light">Electric servo motors for faster, more accurate control</p>
            </motion.div>
            ...
            >
              ...
              <div className="text-sm font-bold uppercase tracking-[0.2em] text-[#450f1a]">Accidental Releases</div>
              <p className="text-[#333333] text-sm mt-3 font-light">Tipple chains run past the linebar to secure small cants</p>
            </motion.div>
            ...
            >
              ...
              <div className="text-sm font-bold uppercase tracking-[0.2em] text-[#450f1a]">Installation</div>
              <p className="text-[#333333] text-sm mt-3 font-light">Pre-wired and tested for efficient startup</p>
            </motion.div>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-20">
            ...
            <p className="text-[#8C9291] mt-6 max-w-2xl mx-auto font-light text-lg">
              Engineered for precision, security, and seamless integration. Discover the core features that drive the Dynamic Linebar.
            </p>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            
            {/* Card 1: Dynamic Positioning */}
            <motion.div 
            ...
            >
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#450f1a]/10 rounded-full blur-3xl -mr-10 -mt-10 transition-all duration-500 group-hover:bg-[#450f1a]/20"></div>
              ...
              <h3 className="text-2xl font-display font-bold text-[#333333] mb-4 uppercase tracking-wide relative z-10">
                Dynamic <span className="text-[#450f1a]">Positioning</span>
              </h3>
              
              <p className="text-[#333333] font-light leading-relaxed mb-8 relative z-10 flex-grow">
                The linebar is positioned based on cant width to perfectly center the cant on the scan belt. This precision reduces cutting tool set times, directly improving overall gang productivity.
              </p>
              
              <ul className="space-y-4 relative z-10 mt-auto">
                <li className="flex items-start gap-3">
                  <Activity className="w-5 h-5 text-[#450f1a] flex-shrink-0 mt-0.5" />
                  <span className="text-[#333333] font-light text-sm">Optimized Centering based on cant width</span>
                </li>
                <li className="flex items-start gap-3">
                  <Zap className="w-5 h-5 text-[#450f1a] flex-shrink-0 mt-0.5" />
                  <span className="text-[#333333] font-light text-sm">Increased Productivity & reduced set times</span>
                </li>
                <li className="flex items-start gap-3">
                  <Layers className="w-5 h-5 text-[#450f1a] flex-shrink-0 mt-0.5" />
                  <span className="text-[#333333] font-light text-sm">Independent Transport via actuated tipple chains</span>
                </li>
              </ul>
            </motion.div>

            {/* Card 2: Secure Transport & Rejection */}
            <motion.div 
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            ...
            >
              ...
              <h3 className="text-2xl font-display font-bold text-[#333333] mb-4 uppercase tracking-wide relative z-10">
                Secure <span className="text-[#450f1a]">Transport</span>
              </h3>
              
              <p className="text-[#333333] font-light leading-relaxed mb-8 relative z-10 flex-grow">
                Independently actuated tipple chains run past the linebar, ensuring small cants won't get accidentally released down the line when the tipples are in the up position.
              </p>
              
              <ul className="space-y-4 relative z-10 mt-auto">
                <li className="flex items-start gap-3">
                  <ShieldCheck className="w-5 h-5 text-[#450f1a] flex-shrink-0 mt-0.5" />
                  <span className="text-[#333333] font-light text-sm">Secure Handling prevents accidental release</span>
                </li>
                <li className="flex items-start gap-3">
                  <Layers className="w-5 h-5 text-[#450f1a] flex-shrink-0 mt-0.5" />
                  <span className="text-[#333333] font-light text-sm">Easy Rejection by fully retracting the linebar</span>
                </li>
              </ul>
            </motion.div>

            {/* Card 3: Advanced Servo Control */}
            <motion.div 
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            ...
            >
              ...
              <p className="text-[#333333] font-light leading-relaxed mb-8 relative z-10 flex-grow">
                Both the linebar and tipple chains utilize electric servo motors, providing faster, more accurate control while significantly lowering maintenance requirements.
              </p>
              
              <ul className="space-y-4 relative z-10 mt-auto">
                <li className="flex items-start gap-3">
                  <Zap className="w-5 h-5 text-[#450f1a] flex-shrink-0 mt-0.5" />
                  <span className="text-[#333333] font-light text-sm">High-Speed Accuracy via electric servos</span>
                </li>
                <li className="flex items-start gap-3">
                  <Settings className="w-5 h-5 text-[#450f1a] flex-shrink-0 mt-0.5" />
                  <span className="text-[#333333] font-light text-sm">Low Maintenance with fewer moving parts</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-[#450f1a] flex-shrink-0 mt-0.5" />
                  <span className="text-[#333333] font-light text-sm">Plug and Play pre-wired and tested</span>
                </li>
              </ul>
            </motion.div>
      ...
      <section className="py-16 px-6 md:px-16 relative overflow-hidden bg-[#0a0a0a]">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <h2 className="text-4xl md:text-5xl font-display font-bold text-white uppercase tracking-widest mb-6 drop-shadow-lg">
            Ready to Upgrade Your <span className="font-bold text-[#540214]">Linebar?</span>
          </h2>
          <p className="text-lg text-[#EBEDEF] font-light mb-10 max-w-2xl mx-auto">
            Contact our engineering team today to discuss how the Dynamic Linebar can integrate into your existing line and maximize your recovery.
          </p>
          <Link 
            to="/contact" 
