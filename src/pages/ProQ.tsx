...
import { ArrowLeft, CheckCircle2, Zap, Settings, ArrowRight, Activity, Layers, ShieldCheck, Crosshair, TrendingUp, Cpu, Target, MoveRight } from 'lucide-react';
import { Link } from 'react-router-dom';

export default function ProQ() {
  return (
    <div className="min-h-screen bg-[#333333] text-white font-sans selection:bg-[#540214] selection:text-white">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-20 w-full pt-32 pb-20 flex flex-col lg:flex-row items-center gap-12">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-display font-bold text-white uppercase tracking-widest leading-[0.9] mb-8 drop-shadow-2xl">
              Pro<span className="text-[#540214]">Q</span>
            </h1>
            ...
            <p className="text-xl md:text-2xl text-[#8C9291] font-light mb-12 max-w-2xl leading-relaxed">
              The ProQ uses short, independently driven, servo motor controlled chain sections to transport cants from the primary breakdown to secondary breakdown machine, continuously tracking position and width envelope.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 divide-y md:divide-y-0 md:divide-x divide-black/10">
            ...
            >
              ...
              <div className="text-sm font-bold uppercase tracking-[0.2em] text-[#450f1a]">Controlled</div>
              <p className="text-[#333333] text-sm mt-3 font-light">Independently driven chain sections</p>
            </motion.div>
            ...
            >
              ...
              <div className="text-sm font-bold uppercase tracking-[0.2em] text-[#450f1a]">Chain Slip</div>
              <p className="text-[#333333] text-sm mt-3 font-light">Minimizes sequencing errors and manual intervention</p>
            </motion.div>
            ...
            >
              ...
              <div className="text-sm font-bold uppercase tracking-[0.2em] text-[#450f1a]">Gap Control</div>
              <p className="text-[#333333] text-sm mt-3 font-light">Maximizes the number of cants queued</p>
            </motion.div>
      ...
      <section id="specs" className="py-24 px-6 md:px-16 bg-gradient-to-b from-black to-[#333333] relative overflow-hidden">
        <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-[#450f1a] rounded-full blur-[200px] opacity-5 pointer-events-none"></div>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              <h3 className="text-2xl font-display font-bold text-[#222222] mb-6 uppercase tracking-wide">
                Dynamic <span className="text-[#222222]">Gap Control</span>
              </h3>
              <div className="w-20 h-1.5 bg-[#450f1a] mb-8"></div>
              <p className="text-[#333333] text-lg mb-8 font-light leading-relaxed">
                Traditional hook decks have hooks spaced for the widest cants, limiting the number of pieces on the transfer. The ProQ dynamically controls the gap between pieces, maximizing the number of cants queued.
              </p>
              <ul className="space-y-6">
                {[
                  { text: "Positions each piece close to the one downstream", icon: Zap },
                  { text: "Reduces risk of starving the secondary breakdown machine", icon: Activity },
                  { text: "Optimized throughput via dynamic gap adjustment", icon: Target }
                ].map((item, idx) => (
                  <li key={idx} className="flex items-start gap-4 group">
                    <div className="w-12 h-12 rounded-xl bg-[#450f1a] flex items-center justify-center flex-shrink-0">
            ...
            >
              ...
              <div className="relative z-10">
                <h3 className="text-2xl font-display font-bold text-[#222222] mb-6 uppercase tracking-wide">
                  Sequencing & <span className="text-[#450f1a]">Orientation</span>
                </h3>
                <div className="w-20 h-1.5 bg-[#450f1a] mb-8"></div>
                <p className="text-[#333333] text-lg mb-8 font-light leading-relaxed">
                  The ProQ minimizes sequencing errors and manual intervention by eliminating chain slip. Pieces are transported in the orientation they arrive from upstream.
                </p>
                <ul className="space-y-6">
                  {[
                    { text: "Zero Chain Slip: Eliminates sequencing errors", icon: Layers },
                    { text: "Maintained Orientation: Transports cants as they arrive", icon: MoveRight },
                    { text: "Reduces waste and significantly improves yield", icon: Settings }
                  ].map((item, idx) => (
                    <li key={idx} className="flex items-start gap-4 group">
                      <div className="w-12 h-12 rounded-xl bg-[#450f1a] flex items-center justify-center flex-shrink-0">
                        <item.icon className="w-6 h-6 text-white" />
            ...
            >
              <h3 className="text-2xl font-display font-bold text-[#222222] mb-6 uppercase tracking-wide">
                Intervention & <span className="text-[#222222] font-bold">Efficiency</span>
              </h3>
              <div className="w-20 h-1.5 bg-[#450f1a] mb-8"></div>
              <p className="text-[#333333] text-lg mb-8 font-light leading-relaxed">
                Servo motor controlled cant turner and independent manual control allows easy intervention. The ProQ is the most energy-efficient solution on the market.
              </p>
              <ul className="space-y-6">
                {[
                  { text: "Servo motor controlled cant turner", icon: ShieldCheck },
                  { text: "Energy Efficient: No frictional losses", icon: Cpu },
                  { text: "Pre-wired and tested for rapid deployment", icon: TrendingUp }
                ].map((item, idx) => (
                  <li key={idx} className="flex items-start gap-4 group">
                    <div className="w-12 h-12 rounded-xl bg-[#450f1a] flex items-center justify-center flex-shrink-0">
                      <item.icon className="w-6 h-6 text-white" />
      ...
      <section className="py-16 px-6 md:px-16 relative overflow-hidden bg-[#0a0a0a]">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <h2 className="text-4xl md:text-5xl font-display font-bold text-white uppercase tracking-widest mb-6 drop-shadow-lg">
            Ready to Upgrade Your <span className="font-bold text-[#540214]">Infeed Deck?</span>
          </h2>
          <p className="text-lg text-[#EBEDEF] font-light mb-10 max-w-2xl mx-auto">
            Contact our team today to discuss how the ProQ can transform your intermediate processing.
          </p>
          <Link 
            to="/contact" 
