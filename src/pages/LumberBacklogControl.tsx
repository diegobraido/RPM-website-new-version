...
import { ArrowLeft, CheckCircle2, Zap, Settings, ArrowRight, Activity, Layers, ShieldCheck, Crosshair, Network, Sliders } from 'lucide-react';
import { Link } from 'react-router-dom';

export default function LumberBacklogControl() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-20 w-full pt-32 pb-20 flex flex-col lg:flex-row items-center gap-12">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-display font-bold text-white uppercase tracking-widest leading-[0.9] mb-8 drop-shadow-2xl">
              Lumber Backlog <span className="text-[#540214]">Control</span>
            </h1>
            <h2 className="text-2xl md:text-4xl font-display text-[#EBEDEF] mb-8 leading-tight">
              Accurate Vision System Management.
            </h2>
            <p className="text-xl md:text-2xl text-[#8C9291] font-light mb-12 max-w-2xl leading-relaxed">
              The RPM backlog control system is a vision system that accurately manages the backlog of lumber at the lug loader, minimizing downtime and improving lug fill rate.
            </p>
          ...
          >
            <img 
              src="/Products/Lumber-backlog-control/Lumber-backlog-control-UI.png" 
              alt="Lumber Backlog Control System" 
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-20">
            <h2 className="text-3xl md:text-5xl font-display font-bold text-white mb-4 uppercase tracking-widest">
              System <span className="text-[#540214]">Advantages</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              ...
              <h3 className="text-2xl font-display font-bold text-[#222222] mb-4 uppercase tracking-wide relative z-10">
                Superior <span className="text-[#540214]">Control</span>
              </h3>
              
              <p className="text-[#333333] font-light leading-relaxed mb-8 relative z-10 flex-grow">
                Superior backlog control minimizes downtime and improves lug fill rate.
              </p>
            </motion.div>
            ...
            >
              ...
              <div className="w-16 h-16 rounded-2xl bg-[#450f1a] flex items-center justify-center mb-8 border border-[#540214] shadow-lg relative z-10">
                <ShieldCheck className="w-8 h-8 text-[#FFB6C1]" />
              </div>
              
              <h3 className="text-2xl font-display font-bold text-[#222222] mb-4 uppercase tracking-wide relative z-10">
                Reduce <span className="text-[#540214]">Cross-ups</span>
              </h3>
              
              <p className="text-[#333333] font-light leading-relaxed mb-8 relative z-10 flex-grow">
                Reduces lug loader cross-ups that result in costly downtime.
              </p>
            </motion.div>
            ...
            >
              ...
              <div className="w-16 h-16 rounded-2xl bg-[#450f1a] flex items-center justify-center mb-8 border border-[#540214] shadow-lg relative z-10">
                <Network className="w-8 h-8 text-[#FFB6C1]" />
              </div>
              
              <h3 className="text-2xl font-display font-bold text-[#222222] mb-4 uppercase tracking-wide relative z-10">
                Minimal <span className="text-[#540214]">Installation</span>
              </h3>
              
              <p className="text-[#333333] font-light leading-relaxed mb-8 relative z-10 flex-grow">
                Power over Ethernet cameras provide minimal electrical and mechanical installation.
              </p>
            </motion.div>
            ...
            >
              ...
              <div className="w-16 h-16 rounded-2xl bg-[#450f1a] flex items-center justify-center mb-8 border border-[#540214] shadow-lg relative z-10">
                <Sliders className="w-8 h-8 text-[#FFB6C1]" />
              </div>
              
              <h3 className="text-2xl font-display font-bold text-[#222222] mb-4 uppercase tracking-wide relative z-10">
                Intuitive <span className="text-[#540214]">Interface</span>
              </h3>
              
              <p className="text-[#333333] font-light leading-relaxed mb-8 relative z-10 flex-grow">
                Intuitive user interface allows the user to monitor and configure the system with ease.
              </p>
            </motion.div>
      ...
      <section className="py-16 px-6 md:px-16 relative overflow-hidden bg-[#0a0a0a]">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <h2 className="text-4xl md:text-5xl font-display font-bold text-white uppercase tracking-widest mb-6 drop-shadow-lg">
            Ready to Improve Your <span className="font-bold text-[#540214]">Lumber Backlog Control?</span>
          </h2>
          <p className="text-lg text-[#EBEDEF] font-light mb-10 max-w-2xl mx-auto">
            Contact our engineering team today to discuss how the Lumber Backlog Control system can integrate into your existing line and maximize your recovery.
          </p>
          <Link 
            to="/contact" 
